...
class SimCSE(object):
    ...
    def __init__(self, model_name_or_path: str, 
        ...
        # https://huggingface.co/transformers/model_doc/auto.html#transformers.AutoTokenizer
        self.tokenizer = AutoTokenizer.from_pretrained(model_name_or_path)
        # https://huggingface.co/transformers/model_doc/auto.html#transformers.AutoModel
        ...
        if pooler is not None:
            ...
            logger.info("Use `cls_before_pooler` for unsupervised models. If you want to use other pooling policy, "
    ...
    def build_index(self, sentences_or_file_path: Union[str, List[str]], 
        ...
        if use_faiss is None or use_faiss:
            try:
                ...
                logger.warning("Fail to import faiss. If you want to use faiss, install faiss through PyPI. Now the "
                               "program continues with brute force search.")
                use_faiss = False
